...
class ConvexPolytope:
  ...
  """
    ...
    def signed_distance(self, poly2: "ConvexPolytope", gamma:float=2., is_conservative: bool = True, skip_gradient: bool = False, epsilon: float = 1e-6, eps_edge: float=1e-6, mode: str ='auto') -> float:
