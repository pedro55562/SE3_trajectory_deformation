// Specialized algorithm for vertex enumeration in 3D
// Faster than cddlib
// https://github.com/ZJU-FAST-Lab/VertexEnumeration3D/
#ifndef VERTEX_ENUMERATION_HPP
#define VERTEX_ENUMERATION_HPP
